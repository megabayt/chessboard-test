...
const Knight = ({ color, stroke }: ChessFigureImageProps) => (
  <Svg height={pieceHeight} width={pieceWidth} viewBox="0 0 50 50">
...
const Bishop = ({ color, stroke }: ChessFigureImageProps) => (
  <Svg height={pieceHeight} width={pieceWidth} viewBox="0 0 50 50">
...
const Rook = ({ color, stroke }: ChessFigureImageProps) => (
  <Svg height={pieceHeight} width={pieceWidth} viewBox="0 0 50 50">
...
const Queen = ({ color, stroke }: ChessFigureImageProps) => (
  <Svg height={pieceHeight} width={pieceWidth} viewBox="0 0 50 50">
...
const King = ({ color, stroke }: ChessFigureImageProps) => (
  <Svg height={pieceHeight} width={pieceWidth} viewBox="0 0 50 50">
